...
<div class="v52fmbx_tbmax v52fmbx_tbmaxmt">
    <div class="v52fmbx_tbbox">
        <h3 class="v52fmbx_hr">
            <div class="formleft">
                <a href="content.php?action=add&lang=cn&anyid=39" title="添加友情链接">+添加友情链接</a>
            </div>
            <div class="formright">
                链接类型
                <select name="new" id="new" onChange="changes($(this));" style="position:relative; top:2px;">
                    <option value="index.php?lang=cn&anyid=39&show_ok=0" >未审核链接</option>
                    <option value="index.php?lang=cn&anyid=39&com_ok=1" >推荐链接</option>
                ...
                <form method="POST" name="myform" action="index.php?search=detail_search&lang=cn&anyid=39" target="_self">
                    <input name="webname" type="text" value="请输入网站标题关键字" class="text" style="width:150px!important;" id="searchtext" />
        ...
        <table cellpadding="0" cellspacing="1" class="table">
            <tr>
                <td colspan="3" style="padding:0px!important;border:0px">
                    <form name="del" method="Post" action="delete.php?lang=cn&anyid=39">
