    ...
    <div class="metcms_cont_left hidden-xs">
        ...
        <dl class="jslist">
            ...
            <dd>
                ...
                <a href="/um/uninersity.html" title="大学管理" id="uninersity"><i style=" font-size: 14px;margin-left: 8px; display: inline;color: #A7C6DC" class="fa fa-link">&nbsp;&nbsp;&nbsp;&nbsp;大学管理</i></a>
                    <a href="/ass/assess.html" title="评估管理" id="assess"><i style=" font-size: 14px;margin-left: 8px; display: inline;color: #A7C6DC" class="fa fa-link">&nbsp;&nbsp;&nbsp;&nbsp;评估管理</i></a>
            </dd>
        </dl>
