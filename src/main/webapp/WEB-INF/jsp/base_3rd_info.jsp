            ...
            <div class="metcms_top_right_box_div clearfix">
                ...
                <div class="btn-group pull-right met-tool">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="langlistbox">
                        ...
                        <li class="met-tool-list"><a href="http://localhost:88/metinfo/admin/index.php?lang=cn&anyid=57&n=webset&c=webset&&a=dothirdparty">简体中文</a></li>

                        <li class="met-tool-list"><a href="http://localhost:88/metinfo/admin/index.php?lang=en&anyid=57&n=webset&c=webset&&a=dothirdparty">English</a></li>

                        <li class="met-tool-list"><a href="http://localhost:88/metinfo/admin/index.php?lang=tc&anyid=57&n=webset&c=webset&&a=dothirdparty">繁体中文</a></li>
