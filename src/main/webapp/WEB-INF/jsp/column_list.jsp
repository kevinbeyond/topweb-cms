                        ...
                        <table cellpadding="0" cellspacing="1" class="table neitable columntables">
                            ...
                            <tr class="mouse click column_1">
                                ...
                                <td class="list-text blues" style="text-align:left;">
                                    ...
                                    <img src='/images/colum1nx.gif' class='columnimg' id='img_1' onclick="oncolumn($(this),'1');" /><input type="text" class="text nonull" value="关于我们" name="name_1" />
                                </td>
                                <td class="list-text">
                                    <select name="nav_1"><option value='0' >不显示</option><option value='1' ><font class='red'>头部主导航条</font></option><option value='2' ><font class='blue'>尾部导航条</font></option><option value='3' selected='selected'><font class='green'>都显示</font></option></select>
                                </td>
                                            ...
                                            <div class="none columnmorediv">
                                                ...
                                                <div class="move">
                                                    <a href="move.php?anyid=25&lang=cn&id=19&action=b1" onClick="return columnMove($(this))">
                                                        移动栏目至
                                                        &nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" />
                                                    </a>
                            ...
                            <tr class="mouse click column_1">
                                ...
                                <td class="list-text blues" style="text-align:left;">
                                    ...
                                    <img src='/images/colum1nx.gif' class='columnimg' id='img_2' onclick="oncolumn($(this),'2');" /><input type="text" class="text nonull" value="新闻资讯" name="name_2" />
                                </td>
                                <td class="list-text">
                                    ...
                                    <div style=" position:relative; z-index:1;">
                                        ...
                                        <div class="columnmore">
                                            ...
                                            <div class="none columnmorediv">
                                                ...
                                                <div class="move">
                                                    <a href="move.php?anyid=25&lang=cn&id=2&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                                                    <div class="moveb1"></div>
                                                </div>
                            ...
                            <tr class="mouse click column_1">
                                ...
                                <td class="list-text blues" style="text-align:left;">
                                    ...
                                    <img src='/images/colum1nx.gif' class='columnimg' id='img_3' onclick="oncolumn($(this),'3');" /><input type="text" class="text nonull" value="产品展示" name="name_3" />
                                </td>
                                <td class="list-text">
                            ...
                            <tr id="class_6" class="none mouse click columnz_3 column_2">
                                ...
                                <td class="list-text2" id="tr6" style="text-align:left; padding-left:10px;">
                                    <img src='/images/bg_columnx.gif' style="position:relative; top:6px;" />
                                    <img src='/images/colum1nx.gif' class='columnimg' id='img_6' style='margin:0px;' onclick="oncolumn($(this),'6');" />
                            ...
                            <tr id="class_14" class="none mouse click columnz_6 column_3">
                                ...
                                <td class="list-text3" style="text-align:left; padding-left:10px;">
                                    <img src='/images/bg_column1.gif' style="float:left; margin-right:3px;" />
...
<tr class="mouse click column_1">
    ...
    <td class="list-text blues" style="text-align:left;">
        ...
        <img src='/images/colum1nx.gif' class='columnimg' id='img_32' onclick="oncolumn($(this),'32');" /><input type="text" class="text nonull" value="下载中心" name="name_32" />
    </td>
    <td class="list-text">
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=32&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=33&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=36&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=37&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=38&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=39&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=40&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
        ...
        <div style=" position:relative; z-index:1;">
            ...
            <div class="columnmore">
                ...
                <div class="none columnmorediv">
                    ...
                    <div class="move">
                        <a href="move.php?anyid=25&lang=cn&id=41&action=b1" onClick="return columnMove($(this))">移动栏目至&nbsp;<img src="/images/metcolumn12.gif" style="position:relative; bottom:2px;" /></a>
                        <div class="moveb1"></div>
                    </div>
